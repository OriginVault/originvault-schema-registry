...
exports.SCHEMA_METADATA = exports.SCHEMA_HASHES = exports.SCHEMA_REGISTRY = void 0;
exports.getSchemaByName = getSchemaByName;
exports.getSchemaHash = getSchemaHash;
exports.validateSchemaHash = validateSchemaHash;
...
function getSchemaByName(name) {
    return exports.SCHEMA_REGISTRY[name];
}
function getSchemaHash(name) {
    return exports.SCHEMA_HASHES[name];
}
function validateSchemaHash(name, hash) {
    return exports.SCHEMA_HASHES[name] === hash;
}
