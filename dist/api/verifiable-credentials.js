...
export const getVCSchemas = (req, res) => {
    try {
...
export const getVCSchema = (req, res) => {
    try {
        const { id } = req.params;
        const schemas = loadSchemasFromFilesystem();
...
export const validateVC = (req, res) => {
    try {
...
export const createVCTemplate = (req, res) => {
    try {
...
export const verifyPresentation = (req, res) => {
    try {
