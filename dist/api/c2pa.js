...
export const addProvenance = async (req, res) => {
    try {
...
export const getProvenance = async (req, res) => {
    try {
...
export const verifyManifest = async (req, res) => {
    try {
...
export const getProvenanceChain = async (req, res) => {
    try {
        const { hash } = req.params;
...
export const createDerivative = async (req, res) => {
    try {
