...
export const registerTrustEntity = async (req, res) => {
    try {
...
export const getTrustEntity = async (req, res) => {
    try {
...
export const getTrustChain = async (req, res) => {
    try {
        const { did } = req.params;
...
export const searchTrust = async (req, res) => {
    try {
