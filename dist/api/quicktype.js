...
export const getGenerationOptions = async (req, res) => {
    try {
        const options = {
            justTypes: {
                type: 'boolean',
...
export const generateFromRegistry = async (req, res) => {
    try {
        const { schemaId, targetLanguage, options } = req.body;
        if (!schemaId) {
...
export const generateFromUrl = async (req, res) => {
    try {
        const { url, targetLanguage, options } = req.body;
        if (!url) {
...
export const cacheGeneratedCode = async (req, res) => {
    try {
        const { key, code, language } = req.body;
...
export const getCachedCode = async (req, res) => {
    try {
...
async function loadSchemaFromRegistry(schemaId) {
    try {
...
export const generateFromFiles = async (req, res) => {
    try {
