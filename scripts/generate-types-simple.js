#!/usr/bin/env node
/**
 * Simple QuickType Multi-Language Type Generation
...
async function loadSchemas(sourceDir) {
...
async function generateTypesForLanguage(config, schemas, layerName) {
...
async function generatePackageMetadata(config, outputPath, layerName) {
...
module.exports = { main, generateTypesForLanguage, loadSchemas }; 